!(function (e) {
  ...
  function (e, t, i) {
    ...
    var r = AFRAME.utils.device.isMobile() || window.hasNonPolyfillWebVRSupport;
    AFRAME.registerComponent("mouse-cursor", {
      ...
      _onClick: function (e) {
        this._isActive() &&
          (this._updateMouse(e),
          this._updateIntersectObject(),
          this._intersectedEl && this._emit("click"));
      },
      _onRelease: function () {
        if (this._isActive()) {
          if (this._defMousePosition) {
            var e = Math.abs(
                this._initMousePosition.x - this._defMousePosition.x
              ),
              t = Math.abs(
                this._initMousePosition.y - this._defMousePosition.y
              ),
              i = Math.max(e, t);
            i > 0.04 && (this._isDown = !1);
          }
          this._isDown && this._intersectedEl && this._emit("mouseup"),
            (this._isDown = !1),
      ...
      _onMouseMove: function (e) {
        this._isActive() &&
          (this._updateMouse(e),
          this._updateIntersectObject(),
          this._isDown && this._setMousePosition(e));
      },
      ...
      _onComponentChanged: function (e) {
        "position" === e.detail.name && this._updateIntersectObject();
      },
      ...
      _setMousePosition: function (e) {
        this._defMousePosition = this._getPosition(e);
      },
      _setInitMousePosition: function (e) {
      ...
      _getChildren: function (e) {
        ...
        return e.children.map(function (e) {
          return "Group" === e.type ? t._getChildren(e) : e;
        });
      },
      _getAllChildren: function () {
        var e = this._getChildren(this.el.sceneEl.object3D);
        return (0, o.default)(e);
      },
      _updateIntersectObject: function () {
        var e = this._raycaster,
          t = this.el,
          i = this._mouse,
          n = (t.sceneEl.object3D, this.el.getObject3D("camera"));
        this._getAllChildren(),
          ...
          e.ray.direction
            ...
            .sub(e.ray.origin)
            .normalize();
        var s = this._getAllChildren(),
          o = e.intersectObjects(s);
        if (o.length > 0) {
          var r = void 0;
          if (
            (o.every(function (e) {
      ...
      _setIntersectObject: function (e) {
      ...
      _clearIntersectObject: function () {
        var e = this._intersectedEl;
        e &&
          !this._isMobile &&
          (e.removeState("hovered"),
          e.emit("mouseleave"),
          this.el.removeState("hovering")),
          (this._intersectedEl = null);
      },
      _emit: function (e) {
        var t = this._intersectedEl;
    ...
    (function (t) {
      ...
      function r(e) {
        return (
          c(e) &&
          C.call(e, "callee") &&
          (!j.call(e, "callee") || P.call(e) == f)
        );
      }
      function h(e) {
        return null != e && a(e.length) && !_(e);
      }
      function c(e) {
        return l(e) && h(e);
      }
      ...
      var v = 1 / 0,
        ...
        g = b || p || Function("return this")(),
        M = Object.prototype,
        C = M.hasOwnProperty,
        P = M.toString,
        L = g.Symbol,
        j = M.propertyIsEnumerable,
